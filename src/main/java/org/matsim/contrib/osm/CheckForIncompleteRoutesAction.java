...
public class CheckForIncompleteRoutesAction extends JosmAction {



    public CheckForIncompleteRoutesAction() {
        super(tr("Check For Incomplete Routes"), null,
                tr("Check For Incomplete Routes"), Shortcut.registerShortcut(
                        "Check For Incomplete Routes",
                        tr("Menu: {0}", tr("Check For Incomplete Routes")),
    ...
    public void actionPerformed(ActionEvent e) {
    	DataSet data = Main.main.getCurrentDataSet();
    		...
    		IncompleteRoutesTest test = new IncompleteRoutesTest();
